        ...
        items: [
            [
                ...
                },
                {
                    ...
                    layerList: [
                        layer(LineLayer, { data: d2.XBTUSD.hopex.价格, color: ETH颜色 }),
                        layer(LineLayer, { data: d.hopex.价格_最高60, color: 卖颜色 }),
                    ]
                },
            ...
            ],
            {
                layerList: [
                    layer(ZeroLayer, { color: 0xaaaaaa }),
                    layer(LineLayer, { data: d.bitmex.折返率, color: 买颜色 }),
                    layer(LineLayer, { data: d.hopex.价格_最高60_价差, color: ETH颜色 }),
                ]
            },
            {
                layerList: [
