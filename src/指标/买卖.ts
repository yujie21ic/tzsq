...
const 买卖 = (p: {
    ...
    return {
        ...
        盘口1: p.盘口1,
        盘口1价: p.盘口1价,
        成交量_累加60: 指标.累加(成交量, 600, RealDataBase.单位时间),

        买成交量累加: 指标.累加(成交量, 60, RealDataBase.单位时间),
        卖成交量累加: 指标.累加(反向成交量, 60, RealDataBase.单位时间),
        //净成交量
        净成交量,
        ...
        净成交量_累加300: 指标.累加(净成交量, 300, RealDataBase.单位时间),
