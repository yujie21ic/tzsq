    ...
    render() {
        ...
        return <div>
            <div style={{
                ...
                <p>委托:{get委托()}</p>
                <p>
                    摸顶:<Switch checked={任务开关.自动开仓摸顶} onChange={(e, v) => { rpc.任务_开关({ cookie, market: this.props.market, symbol: this.props.symbol, 任务名字: '自动开仓摸顶', value: v }) }} />
                    抄底:<Switch checked={任务开关.自动开仓抄底} onChange={(e, v) => { rpc.任务_开关({ cookie, market: this.props.market, symbol: this.props.symbol, 任务名字: '自动开仓抄底', value: v }) }} />
                </p>
                <p>
                    追涨:<Switch checked={任务开关.自动开仓追涨} onChange={(e, v) => { rpc.任务_开关({ cookie, market: this.props.market, symbol: this.props.symbol, 任务名字: '自动开仓追涨', value: v }) }} />
                    追跌:<Switch checked={任务开关.自动开仓追跌} onChange={(e, v) => { rpc.任务_开关({ cookie, market: this.props.market, symbol: this.props.symbol, 任务名字: '自动开仓追跌', value: v }) }} />
                </p>
                <p>
                    止盈波段:<Switch checked={任务开关.自动止盈波段} onChange={(e, v) => { rpc.任务_开关({ cookie, market: this.props.market, symbol: this.props.symbol, 任务名字: '自动止盈波段', value: v }) }} />
                    推止损:<Switch checked={任务开关.自动推止损} onChange={(e, v) => { rpc.任务_开关({ cookie, market: this.props.market, symbol: this.props.symbol, 任务名字: '自动推止损', value: v }) }} />
                </p>
                <p>
                    止损:<Switch checked={任务开关.自动止损} onChange={(e, v) => { rpc.任务_开关({ cookie, market: this.props.market, symbol: this.props.symbol, 任务名字: '自动止损', value: v }) }} />
                </p>
            </div>
