        ...
        const 信号_上涨 = 指标.lazyMapCache(
            ...
            i => {
                ...
                if (盘口买[i] > 250 * 10000) {
                    ...
                    const 盘口买_0_50万 = 盘口买[i] < 50 * 10000
                    const 盘口买_0_100万 = 盘口买[i] < 100 * 10000
                    const 盘口买_0_200万 = 盘口买[i] < 200 * 10000
                    const 盘口买_50_100万 = 盘口买[i] >= 50 * 10000 && 盘口买[i] < 100 * 10000
                    const 盘口买_100_150万 = 盘口买[i] >= 100 * 10000 && 盘口买[i] < 150 * 10000
        ...
        const 信号_下跌 = 指标.lazyMapCache(
            ...
            i => {
                ...
                if (盘口卖[i] > 250 * 10000) {
                    ...
                    const 盘口卖_0_50万 = 盘口卖[i] < 50 * 10000
                    const 盘口卖_0_100万 = 盘口卖[i] < 100 * 10000
                    const 盘口卖_0_150万 = 盘口卖[i] < 150 * 10000 //买是200 卖是 150 ？？？
                    const 盘口卖_50_100万 = 盘口卖[i] >= 50 * 10000 && 盘口卖[i] < 100 * 10000
                    const 盘口卖_100_150万 = 盘口卖[i] >= 100 * 10000 && 盘口卖[i] < 150 * 10000
