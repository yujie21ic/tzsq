        ...
        const 信号_上涨 = 指标.lazyMapCache(
            ...
            i => {
                ...
                if (盘口买[i] > 250 * 10000) {
                    ...
                    if (上涨_价差[i] < 价差中大分界) {
                        const aaa = 盘口买[i] < 100 * 10000 && x__1
                        const bbb = 盘口买[i] >= 100 * 10000 && 盘口买[i] < 150 * 10000 && x__2
                        b = aaa || bbb
                    } else {
                        const aaa = 真空信号涨[i] && 盘口买[i] < 200 * 10000
                        const bbb = 盘口买[i] < 50 * 10000 && x__1
                        const ccc = 盘口买[i] >= 50 * 10000 && 盘口买[i] < 100 * 10000 && x__2
                        b = aaa || bbb || ccc
                    }
                }
        ...
        const 信号_下跌 = 指标.lazyMapCache(
            ...
            i => {
                ...
                if (盘口卖[i] > 250 * 10000) {
                    ...
                    if (下跌_价差[i] < 价差中大分界) {
                        const aaa = 盘口卖[i] < 100 * 10000 && x__1
                        const bbb = 盘口卖[i] >= 100 * 10000 && 盘口卖[i] < 150 * 10000 && x__2
                        b = aaa || bbb
                    } else {
                        const aaa = 真空信号涨[i] && 盘口卖[i] < 150 * 10000
                        const bbb = 盘口卖[i] < 50 * 10000 && x__1
                        const ccc = 盘口卖[i] >= 50 * 10000 && 盘口卖[i] < 100 * 10000 && x__2
                        b = aaa || bbb || ccc
                    }
