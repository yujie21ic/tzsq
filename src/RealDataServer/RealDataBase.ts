        ...
        const 信号_上涨 = 指标.lazyMapCache(
            ...
            i => {
                ...
                if (盘口买[i] > 250 * 10000) {
                    ...
                    //
                    const aaa = 小 && 盘口买[i] < 100 * 10000 && x__1
                    const bbb = 小 && 盘口买[i] >= 100 * 10000 && 盘口买[i] < 150 * 10000 && x__2
                    const ccc = 大 && 真空信号涨[i] && 盘口买[i] < 200 * 10000
                    const ddd = 大 && 盘口买[i] < 50 * 10000 && x__1
                    const eee = 大 && 盘口买[i] >= 50 * 10000 && 盘口买[i] < 100 * 10000 && x__2
        ...
        const 信号_下跌 = 指标.lazyMapCache(
            ...
            i => {
                ...
                if (盘口卖[i] > 250 * 10000) {
                    ...
                    const aaa = 小 && 盘口卖[i] < 100 * 10000 && x__1
                    const bbb = 小 && 盘口卖[i] >= 100 * 10000 && 盘口卖[i] < 150 * 10000 && x__2
                    const ccc = 大 && 真空信号涨[i] && 盘口卖[i] < 150 * 10000
                    const ddd = 大 && 盘口卖[i] < 50 * 10000 && x__1
                    const eee = 大 && 盘口卖[i] >= 50 * 10000 && 盘口卖[i] < 100 * 10000 && x__2
                    b = aaa || bbb || ccc || ddd || eee
                }
