        ...
        const 信号_上涨 = 指标.lazyMapCache(
            ...
            i => {
                ...
                if (盘口买[i] > 250 * 10000) {
                    ...
                    if (上涨_价差[i] < 价差中大分界) {
                        const aaa = 盘口买[i] < 100 * 10000 && 净盘口[i] <= (净盘口_均线5[i] + 50 * 10000) && 净盘口[i] < 5 * 100000
                        const bbb = 盘口买[i] >= 100 * 10000 && 盘口买[i] < 150 * 10000 && 净盘口[i] <= (净盘口_均线5[i]) && 净盘口[i] < 0
                        if (aaa || bbb) {
                            b = true
                        }
                    } else {
                        const aaa = 真空信号涨[i] && 盘口买[i] < 200 * 10000
                        const bbb = 盘口买[i] < 50 * 10000 && 净盘口[i] <= (净盘口_均线5[i] + 50 * 10000) && 净盘口[i] < 5 * 100000
                        const ccc = 盘口买[i] >= 50 * 10000 && 盘口买[i] < 100 * 10000 && 净盘口[i] <= (净盘口_均线5[i]) && 净盘口[i] < 0
                        if (aaa || bbb || ccc) {
                            b = true
                        }
                    }
        ...
        const 信号_下跌 = 指标.lazyMapCache(
            ...
            i => {
                ...
                if (盘口卖[i] > 250 * 10000) {
                    ...
                    if (下跌_价差[i] < 价差中大分界) {
                        const aaa = 盘口卖[i] < 100 * 10000 && 净盘口[i] >= (净盘口_均线5[i] - 50 * 10000) && 净盘口[i] > (- 50 * 10000)
                        const bbb = 盘口卖[i] >= 100 * 10000 && 盘口卖[i] < 150 * 10000 && 净盘口[i] >= 净盘口_均线5[i] && 净盘口[i] > 0
                        if (aaa || bbb) {
                            b = true
                        }
                    } else {
                        const aaa = 真空信号涨[i] && 盘口卖[i] < 150 * 10000
                        const bbb = 盘口卖[i] < 50 * 10000 && 净盘口[i] >= (净盘口_均线5[i] - 50 * 10000) && 净盘口[i] > (- 50 * 10000)
                        const ccc = 盘口卖[i] >= 50 * 10000 && 盘口卖[i] < 100 * 10000 && 净盘口[i] >= 净盘口_均线5[i] && 净盘口[i] > 0
                        if (aaa || bbb || ccc) {
                            b = true
                        }
                    }
